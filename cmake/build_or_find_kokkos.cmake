...
if(MANDELBROT_KOKKOS_BUILD)
  ...
  message("[mandelbrot / kokkos] Building kokkos from source")
  ...
  elseif(MANDELBROT_KOKKOS_BACKEND MATCHES "Undefined")
    ...
    message(FATAL_ERROR "[mandelbrot / kokkos] You must chose a valid MANDELBROT_KOKKOS_BACKEND !")
  ...
  if(TARGET Kokkos::kokkos)
    message("[mandelbrot / kokkos] Kokkos found (using FetchContent)")
    set(MANDELBROT_KOKKOS_FOUND True)
    set(HAVE_KOKKOS 1)
  else()
    message("[mandelbrot / kokkos] we shouldn't be here. We've just integrated kokkos build into mandelbrot build !")
  endif()
  ...
  if(TARGET Kokkos::kokkos)
    ...
    message("[mandelbrot / kokkos] Kokkos found via find_package; default backend is ${MANDELBROT_KOKKOS_BACKEND}")
    set(MANDELBROT_KOKKOS_FOUND True)
    set(HAVE_KOKKOS 1)

  else()

    message(FATAL_ERROR "[mandelbrot / kokkos] Kokkos is required but not found by find_package. Please adjust your env variable CMAKE_PREFIX_PATH (or Kokkos_ROOT) to where Kokkos is installed on your machine !")
